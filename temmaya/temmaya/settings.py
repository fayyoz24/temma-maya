"""
Django settings for temmaya project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'user': '200/minute',  # 100 requests per minute for authenticated users
    },
}
...
MIDDLEWARE = [
    ...
    'temmaya.middleware.BlockBlockedIPsMiddleware',  # Add custom IP blocking middleware here
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]
ROOT_URLCONF = 'temmaya.urls'
...
WSGI_APPLICATION = 'temmaya.wsgi.application'
